...
public class ParkingLotDemo {
    public static void main(String[] args) {
        ...
        List<ParkingSpot> parkingSpotsFloor1 = List.of(
                ParkingSpotFactory.createParkingSpot(ParkingSpotType.COMPACT, "101"),
                ParkingSpotFactory.createParkingSpot(ParkingSpotType.REGULAR, "102"),
        ...
        try {
            ...
            parkingLot.unparkVehicle("ABC123"); // invalid license number
        } catch (Exception e) {
