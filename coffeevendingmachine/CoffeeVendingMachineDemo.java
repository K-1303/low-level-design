...
public class CoffeeVendingMachineDemo {
    public static void main(String[] args) {
        ...
        machine.insertMoney(100); // Total 100, price is 150
        machine.dispenseCoffee(); // Should prompt for more money
        machine.cancel(); // Cancel the transaction
        inventory.printInventory(); // Inventory should remain unchanged
