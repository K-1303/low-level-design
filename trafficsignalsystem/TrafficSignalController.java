...
public class TrafficSignalController {
    ...
    public TrafficSignalController(Map<Direction, TrafficLight> signals,  
    ...
    public void scheduleStateChange(TrafficLight light, Direction direction, SignalState newState, int delaySeconds) {
        scheduler.schedule(() -> {
